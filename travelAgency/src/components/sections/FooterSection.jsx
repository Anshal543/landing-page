  ...
  return (
    <section>
      <div className="flex flex-col md:flex-row justify-between gap-8 mt-20 ">
        <div>
          <p>
            <img src="/images/logo-button.png" alt="footer logo" />
          </p>
          <p className="text-lightGray mt-[1.19rem]">
            Book your trip in minute, get full Control for much longer.
          </p>
        </div>
        <div className="flex gap-8 flex-grow justify-between max-sm:flex-col max-sm:items-center">
        ...
        <div className="flex flex-col gap-4 items-center">
          <div className="flex gap-4 items-center">
            ...
            <img src="/images/twitter-icon.png" alt="social icon" />
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <div className="bg-lightBlack rounded-extraLarge px-[1.06rem] py-[0.58rem] w-[11rem]">
              <div className="flex gap-4 items-center">
                <div>
                  <img src="/images/apple-icon.png" alt="google play icon" />
                </div>
